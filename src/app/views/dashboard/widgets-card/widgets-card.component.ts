...
@Component({
    ...
    imports: [RowComponent, ColComponent, WidgetStatAComponent, TemplateIdDirective, ChartjsComponent]
})
export class WidgetsCardComponent implements OnInit, AfterContentInit {
